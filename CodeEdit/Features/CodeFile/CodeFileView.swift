...
struct CodeFileView: View {
  ...
  @State private var selectedTheme =
    ThemeModel.shared.selectedTheme ?? ThemeModel.shared.themes.first!
  ...
  @State private var bracketPairHighlight: BracketPairHighlight? = {
    ...
    let color =
      Settings[\.textEditing].bracketHighlight.useCustomColor
...
extension SettingsData.TextEditingSettings.IndentOption {
  fileprivate func textViewOption() -> IndentOption {
