...
extension TextEditingSettingsView {
  ...
  @ViewBuilder private var bracketPairHighlight: some View {
    Group {
      Picker(
        ...
        Text("Disabled").tag(
          SettingsData.TextEditingSettings.BracketPairHighlight.HighlightType.disabled)
        Divider()
        Text("Bordered").tag(
          SettingsData.TextEditingSettings.BracketPairHighlight.HighlightType.bordered)
        Text("Flash").tag(SettingsData.TextEditingSettings.BracketPairHighlight.HighlightType.flash)
        Text("Underline").tag(
          SettingsData.TextEditingSettings.BracketPairHighlight.HighlightType.underline)
      }
