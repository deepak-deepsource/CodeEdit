...
extension GeneralSettingsView {
  fileprivate var appearance: some View {
  ...
  fileprivate var showIssues: some View {
  ...
  fileprivate var showLiveIssues: some View {
    Toggle("Show Live Issues", isOn: $settings.showLiveIssues)
  }

  fileprivate var fileExtensions: some View {
    Group {
  ...
  fileprivate var fileIconStyle: some View {
  ...
  fileprivate var tabBarStyle: some View {
  ...
  fileprivate var navigatorTabBarPosition: some View {
  ...
  fileprivate var inspectorTabBarPosition: some View {
  ...
  fileprivate var reopenBehavior: some View {
  ...
  fileprivate var afterWindowsCloseBehaviour: some View {
    Picker(
  ...
  fileprivate var projectNavigatorSize: some View {
  ...
  fileprivate var findNavigatorDetail: some View {
  ...
  fileprivate var issueNavigatorDetail: some View {
  ...
  fileprivate var dialogWarnings: some View {
  ...
  fileprivate var shellCommand: some View {
  ...
  fileprivate func installShellCommand() {
    do {
      let url = Bundle.main.url(
        forResource: "codeedit", withExtension: nil, subdirectory: "Resources")
  ...
  fileprivate var updateChecker: some View {
    Section {
      LabeledContent {
        Button("Check Now") {
  ...
  private static func configure<Subject>(_ subject: Subject, configuration: (inout Subject) -> Void)
    -> Subject
  {
    var copy = subject
    configuration(&copy)
  ...
  fileprivate func fallbackShellInstallation(commandPath: String, destinationPath: String) {
    let cmd = [
      "osascript",
      "-e",
  ...
  fileprivate var openInCodeEditToggle: some View {
  ...
  fileprivate var revealFileOnFocusChangeToggle: some View {
